...
class SettingsActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        findViewById<LinearLayout>(R.id.bitrateRow).setOnClickListener {
            showBitrateDialog()
        }

        findViewById<LinearLayout>(R.id.frameRateRow).setOnClickListener {
            showFrameRateDialog()
        }

        findViewById<LinearLayout>(R.id.countdownRow).setOnClickListener {
            showCountdownDialog()
        }

        findViewById<LinearLayout>(R.id.bubblePositionRow).setOnClickListener {
            showBubblePositionDialog()
        }

        findViewById<LinearLayout>(R.id.batteryRow).setOnClickListener {
        ...
        findViewById<LinearLayout>(R.id.backupFolderRow).setOnClickListener {
    ...
    private fun showResolutionDialog() {
        ...
        val current = resolutionOptions.indexOf(
    ...
    private fun showBitrateDialog() {
        val labels = bitrateOptions.map {
            if (it == 0) "Automatique (recommandé)" else "$it Mbps"
        }.toTypedArray()

        val current = bitrateOptions.indexOf(
    ...
    private fun showFrameRateDialog() {
        val labels = frameRateOptions.map {
            if (it == 0) "Automatique (recommandé)" else "$it FPS"
        }.toTypedArray()

        val current = frameRateOptions.indexOf(
    ...
    private fun showCountdownDialog() {
        val labels = countdownOptions.map {
            if (it == 0) {
                "Aucun"
            } else if (it == 10) {
                "10s 💎 Pro"
        ...
        val current = countdownOptions.indexOf(
    ...
    private fun showBubblePositionDialog() {
        val current = bubblePositions.indexOf(
